        ...
        <div className="w-full h-auto top-16 absolute bg-[#F6F5EF]">
            <div className="w-[70%] h-full left-[15%] relative mt-10 flex flex-col justify-center items-center">
                    ...
                    <div className=" w-full h-[120px] mt-5">
                        ...
                        <Link href="/photography/bay-area" className="min-w-[175px] absolute right-[50%] translate-x-1/2 text-[#494F48] w-[150px] font-inter font-semibold flex-col justify-center items-center">{selectedFolder()}<span className="flex items-center justify-center">{'Bay Area (2023)'}</span></Link>
            ...
            <div className=" relative h-[400px] bottom-[0%] mt-[110px] w-[70%] left-[15%]">
                
                
                <div className="absolute top-0 left-0 ">
                    <PhotoWindow
                w={443}
                name="/bay-area/basketball.jpeg"
                />
                </div>
                <div className="absolute top-0 right-0">
                    <PhotoWindow
                w={443}
                name="/bay-area/nice-sunset.jpeg"
                />
                </div>
                <div className="absolute left-[50%] -translate-x-1/2">
                    <PhotoWindow
                w={250}
                name="/bay-area/microsoft.jpeg"
                />
                </div>
            </div> 
