        ...
        <div className="w-full h-auto top-16 absolute bg-[#F6F5EF]">
            <div className="w-[70%] h-full left-[15%] relative mt-10 flex flex-col justify-center items-center">
                    ...
                    <div className=" w-full h-[120px] mt-5">
                        ...
                        <Link href="/photography/misc" className="absolute right-0 text-[#494F48] w-[150px] font-inter font-semibold flex-col justify-center items-center">{selectedFolder()}<span className="flex items-center justify-center">{'Misc (2023)'}</span></Link>
                    </div>
            </div>  
