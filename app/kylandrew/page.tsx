...
export default function Page() {
    ...
    useEffect(() => {
        function updateTime() {
            const time = new Date();
            let correctSeconds = time.getSeconds().toString();
            let correctHour = time.getHours().toString();
            let correctMinutes = time.getMinutes().toString();
            let whichHalf = 'am'
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            else if (scrolled >= 550 && scrolled < 1563){
                setMay(['', ''])
                setJune(['700', '#E0DB5E'])
                setJuly(['', ''])
                setNovember(['', ''])
            ...
            else if (scrolled >= 1563 && scrolled < 2500){
                setMay(['', ''])
                setJune(['', ''])
                setJuly(['700', '#93BDDB'])
                setNovember(['', ''])
            ...
            else if (scrolled >= 2500 && scrolled < 3550){
                setMay(['', ''])
                setJune(['', ''])
                setJuly(['', ''])
            ...
            else if (scrolled >= 3550 && scrolled < 5668){
                setMay(['', ''])
                setJune(['', ''])
                setJuly(['', ''])
                setNovember(['', ''])
